...
namespace Dijabetes
{
    public partial class Meals : System.Web.UI.Page
    {
        ...
        protected void Insert(object sender, EventArgs e)
        {
            ...
            string query = "INSERT INTO MealName VALUES(@Name)";
            using (SqlConnection con = new SqlConnection("Data Source=(LocalDB)\\MSSQLLocalDB;AttachDbFilename=|DataDirectory|\\Database1.mdf;Integrated Security=True"))
            {
        ...
        protected void OnRowUpdating(object sender, GridViewUpdateEventArgs e)
        {
            ...
            string query = "UPDATE MealName SET Name=@Name WHERE Id=@Id";
        ...
        {
            int mealId = Convert.ToInt32(GridView1.DataKeys[e.RowIndex].Values[0]);
            string query = "DELETE FROM MealName WHERE Id=@Id";
            using (SqlConnection con = new SqlConnection("Data Source=(LocalDB)\\MSSQLLocalDB;AttachDbFilename=|DataDirectory|\\Database1.mdf;Integrated Security=True"))
            {
                using (SqlCommand cmd = new SqlCommand(query))
                {
